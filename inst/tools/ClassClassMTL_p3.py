...
tensor_train = {xs: np.concatenate([resampleGammaXYsc[0],resampleGammaXYpat[0]]), ys_sc: resampleGammaXYsc[1], ys_pat: resampleGammaXYpat[1], lsc: len(train_sc2)*2, lpat: len(train_pat2)*2, kprob: do_prc}
